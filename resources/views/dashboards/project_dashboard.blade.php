            ...
            <div class="col-xxl-9 box-col-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header card-no-border total-revenue">
                                <h4>Today Work</h4><a href="{{ route('admin.product') }}">View All </a>
                            </div>
                            <div class="card-body pt-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">App Design</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">NFT
                                                        Illustration...</a>
                                                </td>
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Assigned to</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">Cody
                                                        Fisher</a></td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">02</a></td>
                                                <td class="text-end">
                                            ...
                                            <tr>
                                                ...
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Arlene McCoy</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">Assigned
                                                        to</a></td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">12</a></td>
                                                <td class="text-end">
                                                    <div class="badge-light-primary product-sub badge rounded-pill ">
                                                        <span>High</span>
                                                    </div>
                                            ...
                                            <tr>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Web Design</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">Appron’s 3D
                                                        Co...</a>
                                                </td>
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Assigned to</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">Kristin
                                                        Watson</a></td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">12</a></td>
                                                <td class="text-end">
                                            ...
                                            <tr>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Desktop App</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">Rental Car</a>
                                                </td>
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Assigned to</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">Darlene
                                                        Robertson</a>
                                                </td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">05</a></td>
                                                <td class="text-end">
                                            ...
                                            <tr>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Template
                                                        ...
                                                        href="{{ route('admin.product') }}">E-commerce</a></td>
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Assigned to</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">Wade
                                                        Warren</a></td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">31</a></td>
                                                <td class="text-end">
                                                    <div class="badge-light-primary product-sub badge rounded-pill ">
                                                        <span>High</span>
                                                    </div>
                                            ...
                                            <tr>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">App Design</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">Food
                                                        Delivery</a></td>
                                                <td> <span class="f-w-500 f-light d-block f-12 mb-1">Assigned to</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">Smith John</a>
                                                </td>
                                                <td><span class="f-w-500 f-light d-block f-12 mb-1">Days Left</span><a
                                                        class="f-w-500 f-14" href="{{ route('admin.product') }}">20</a></td>
                                                <td class="text-end">
                                                    <div class="badge-light-warning product-sub badge rounded-pill ">
                                                        <span>Medium</span>
                                                    </div>
                                    ...
                                    <div class="projectlist-card">
                                        <div class="projectlist">
                                            <div class="project-data"><img class="nft-img img-fluid"
                                                    ...
                                                    alt="nft">
                                                <div> <a class="f-14 f-w-500 d-block" href="{{ route('admin.product') }}">Net
                                                        Banking
                                        ...
                                        <div class="project-meeting-details">
                                            ...
                                            <div class="project-meeting-time"><a class="f-14 f-w-500 "
                                                    href="{{ route('admin.calendar_basic') }}">2 Nov 23,10:00 AM</a><a
                                                    class="f-14 f-w-500 " href="{{ route('admin.calendar_basic') }}">8 Nov
                                                    23,09:45 AM</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="projectlist-card">
                                        <div class="projectlist">
                                            <div class="project-data"><img class="nft-img img-fluid"
                                                    ...
                                                    alt="nft">
                                                <div><a class="f-14 f-w-500 d-block" href="{{ route('admin.product') }}">NFT
                                ...
                                <div class="col-xl-4 box-col-none marketing-app-card">
                                    <div class="projectlist-card">
                                        <div class="projectlist">
                                            <div class="project-data"> <img class="nft-img img-fluid"
                                                ...
                                                <div><a class="f-14 f-w-500 d-block"
                                                        href="{{ route('admin.product') }}">Marketing App
                                        ...
                                        <div class="project-meeting-details">
                                            ...
                                            <div class="project-meeting-time"> <a class="f-14 f-w-500 "
                                                    href="{{ route('admin.calendar_basic') }}">6 Nov 23,2:56 PM</a><a
                                                    class="f-14 f-w-500 " href="{{ route('admin.calendar_basic') }}">10 Nov 23,
                                                    7:12
                                                    AM</a></div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xxl-12">
                        <div class="card recent-order">
                            <div class="card-header card-no-border total-revenue">
                                ...
                                <div class="header-top"></div><a href="{{ route('admin.product') }}">View All </a>
                            </div>
                            <div class="card-body pt-0">
                                    ...
                                    <table class="order-table project-table w-100">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="project-comment  d-flex gap-2">
                                                        ...
                                                        <div> <a class="f-w-500 f-14 " href="{{ route('admin.product') }}">Pet
                                                                App
                                                                Design</a>
                                                            <div class="project-comment-icon">
                                                                <div class="project-link">
                                                ...
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">Darrell Steward</a><span
                                                            class="f-w-500 f-light f-12 d-block">darrells@example.com</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">15 Nov, 2024</a><span
                                                            class="f-w-500 f-light f-12 d-block">8 Days Left</span></div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">Team Roha</a><span
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-comment  d-flex gap-2">
                                                        ...
                                                        <div> <a class="f-w-500 f-14 "
                                                                href="{{ route('admin.product') }}">Chain Desktop
                                                                App</a>
                                                            <div class="project-comment-icon">
                                                                <div class="project-link">
                                                                    <svg>
                                                ...
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">Eleanor Pena</a><span
                                                            class="f-w-500 f-light f-12 d-block">pena12@example.com</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">20 Nov, 2024</a><span
                                                            class="f-w-500 f-light f-12 d-block">13 Days Left</span></div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">Team Suresh</a><span
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-comment  d-flex gap-2">
                                                        ...
                                                        <div> <a class="f-w-500 f-14 "
                                                                href="{{ route('admin.product') }}">Business Web
                                                                Design</a>
                                                            <div class="project-comment-icon">
                                                                <div class="project-link">
                                                                    <svg>
                                                ...
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">Robert Fox</a><span
                                                            class="f-w-500 f-light f-12 d-block">foxxxx8s@example.com</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">22 Nov, 2024</a><span
                                                            class="f-w-500 f-light f-12 d-block">15 Days Left</span></div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">Team Liza</a><span
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-comment  d-flex gap-2">
                                                        ...
                                                        <div> <a class="f-w-500 f-14 " href="{{ route('admin.product') }}">NFT
                                                                App
                                                                Design</a>
                                                            <div class="project-comment-icon">
                                                                <div class="project-link">
                                                ...
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">Arlene McCoy</a><span
                                                            class="f-w-500 f-light f-12 d-block">arlene78@example.com</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">28 Nov, 2024</a><span
                                                            class="f-w-500 f-light f-12 d-block">21 Days Left</span></div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">Team Sulekha</a><span
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="project-comment  d-flex gap-2">
                                                        ...
                                                        <div> <a class="f-w-500 f-14 "
                                                                href="{{ route('admin.product') }}">Digital Avtar
                                                                Web Design</a>
                                                            <div class="project-comment-icon">
                                                                <div class="project-link">
                                                                    <svg>
                                                ...
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">Courtney Henry</a><span
                                                            class="f-w-500 f-light f-12 d-block">henry45@example.com</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">2 Dec, 2024</a><span
                                                            class="f-w-500 f-light f-12 d-block">25 Days Left</span></div>
                                                </td>
                                                <td>
                                                    <div class="product-sub"><a class="f-w-500 f-14 "
                                                            href="{{ route('admin.product') }}">Team Shreena</a><span
                                                            class="f-w-500 f-light f-12 d-block">12 Member</span></div>
                                                </td>
                                                <td>
                                                    <div
            ...
            <div class="col-xxl-3 d-xxl-block d-none activity-group box-col-none">
                <div class="card add-project-link">
                    ...
                    <div class="categories-content"> <span class="text-truncate col-8 f-12 d-block mb-2">Let’s add work to
                            your space</span><a href="{{ route('admin.create_project') }}">+Add Project </a></div>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                                                ...
                                                <div>
                                                    <div class="common-space user-id">
                                                        <h6> <a class="f-w-500 f-12"
                                                                href="{{ route('admin.user_profile') }}">Jenny
                                                    ...
                                                    <div class="d-flex mb-2"><span class="f-light f-w-500 f-12">Commented
                                                        ...
                                                        href="{{ route('admin.user_profile') }}"></a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="activity-log">
                                            <div class="d-flex align-items-start gap-2"><img
                                                ...
                                                <div>
                                                    <div class="common-space user-id">
                                                        <h6> <a class="f-w-500 f-12"
                                                                href="{{ route('admin.user_profile') }}">Darlene
                                                    ...
                                                    <div class="d-flex mb-2"><span class="f-light f-w-500 f-12">Shared
                                                            ...
                                                            href="{{ route('admin.blog') }}">Barkha</a></div><span
                                            ...
                                            <div class="d-flex align-items-start gap-2"><img
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex mb-2"><span class="f-light f-w-500 f-12">Meeting :
                                                        ...
                                                        class="f-12 f-w-500 username"
                                                        href="{{ route('admin.user_profile') }}">@barkha_singh</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="activity-log">
                                            <div class="d-flex align-items-start gap-2"><img
                                                ...
                                                <div>
                                                    <div class="common-space user-id">
                                                        <h6> <a class="f-w-500 f-12"
                                                                href="{{ route('admin.user_profile') }}">Elara
                                        ...
                                        <li class="activity-log">
                                            <div class="d-flex align-items-start gap-2"><img
                                                ...
                                                <div>
                                                    <div class="common-space user-id">
                                                        <h6> <a class="f-w-500 f-12"
                                                                href="{{ route('admin.user_profile') }}">Arya
                    ...
                    <div class="col-xl-12 col-md-6">
                        <div class="card">
                            <div class="card-header card-no-border total-revenue card-title-underline">
                                <h4>Message</h4><a href="{{ route('admin.product') }}">+ New Message </a>
                            </div>
                            <div class="card-body pt-0">
                                                ...
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="{{ route('admin.user_profile') }}">Maren
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                ...
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="{{ route('admin.user_profile') }}">Brooklyn
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                ...
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="{{ route('admin.user_profile') }}">Floyd
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                ...
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="{{ route('admin.user_profile') }}">Dianne
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                ...
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="{{ route('admin.user_profile') }}">Ralph
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                ...
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="{{ route('admin.user_profile') }}">Ronald
                                        ...
                                        <li>
                                            <div class="activity-log"><img
                                                ...
                                                <div class="activity-name">
                                                    <div>
                                                        <h6> <a class="f-w-500 f-14"
                                                                href="{{ route('admin.user_profile') }}">Courtney
                            ...
                            <div class="card-body pt-0 project-ideas-card">
                                <div class="project-card">
                                    <div><span class="f-22 f-w-500 text-center">Get more ideas for your important
                                            project</span>
                                        <div class="btn-showcase text-center"> <a href="{{ route('admin.pricing') }}">
