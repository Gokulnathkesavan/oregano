    ...
    <div class="container-fluid">
        <div class="row size-column">
                    ...
                    <div class="col-md-12 col-sm-6">
                        <div class="card boost-up-card overflow-hidden">
                            <div class="p-4">
                                ...
                                <div class="btn-showcase text-start"> <a href="{{ route('admin.pricing') }}">
            ...
            <div class="col-xxl-4 col-md-6 box-col-6">
                <div class="card height-equal">
                    <div class="card-header card-no-border total-revenue">
                        <h4>Top Product </h4><a href="{{ route('admin.product') }}">View All </a>
                    </div>
                    <div class="card-body pt-0">
                                    ...
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            <div><span class="badge rounded-pill badge-light text-dark">SKU90400</span>
                                                ...
                                                href="{{ route('admin.product') }}">Huawai Smart
                                ...
                                <li class="d-flex top-product gap-2">
                                    ...
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            ...
                                            </div><a class="f-10 f-w-500  line-clamp" href="{{ route('admin.product') }}">Noise
                                                - Wireless
                                ...
                                <li class="d-flex top-product gap-2">
                                    ...
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            ...
                                            </div><a class="f-10 f-w-500  line-clamp" href="{{ route('admin.product') }}">Men
                                                &amp; Women
                                ...
                                <li class="d-flex top-product gap-2">
                                    ...
                                    <div class="w-100 d-flex justify-content-between align-items-center">
                                        <div class="product-details">
                                            ...
                                            </div><a class="f-10 f-w-500  line-clamp" href="{{ route('admin.product') }}">Anime
                                                White Half
                                                Sleev
            ...
            <div class="col-xxl-5 col-sm-6 box-col-6">
                <div class="card height-equal">
                    <div class="card-header card-no-border total-revenue pb-0">
                        <h4>Team Activity </h4><a href="{{ route('admin.product') }}">View All </a>
                    </div>
                    <div class="card-body pt-0">
            ...
            <div class="col-xxl-5 col-xl-6 box-col-6">
                <div class="card">
                    <div class="card-header card-no-border total-revenue">
                        <h4>Latest Transaction</h4><a href="{{ route('admin.product') }}">View All</a>
                    </div>
                    <div class="card-body pt-0">
                            ...
                            <table class=" w-100 tranaction-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="{{ route('admin.product') }}">Darrell Steward</a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="{{ route('admin.product') }}">Floyd
                                                    Miles</a></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="{{ route('admin.product') }}">Ralph
                                                    Edwards</a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="{{ route('admin.product') }}">Jerome
                                                    Bell</a></div>
                                        </td>
                                        <td class="f-14 f-w-500">16 Nov, 2024</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="{{ route('admin.product') }}">Theresa Webb</a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-name"><a class=" f-14 f-w-500"
                                                    href="{{ route('admin.product') }}">Courtney Henry</a>
                                            </div>
                                        </td>
