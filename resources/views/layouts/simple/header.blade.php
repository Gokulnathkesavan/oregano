              ...
              <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
                  <div> <a class="toggle-sidebar" href="#"> <i class="iconly-Category icli"> </i></a>
                      <div class="d-flex align-items-center gap-2 ">
                          <h4 class="f-w-600">Welcome</h4><img class="mt-0"
                  ...
                  <div class="welcome-content d-xl-block d-none"><span class="text-truncate col-12">Here’s what’s
                          happening with your Draw Box! today. </span></div>
              </div>
                  ...
                  <ul class="nav-menus">
                                                              ...
                                                              <li class="pr-0 pl-0 pb-3 pt-3">
                                                                  <div class="media"><img
                                                                      ...
                                                                      <div class="media-body"><a
                                                                              ...
                                                                              href="{{ route('admin.product') }}">Men Blue
                                                                              T-Shirt</a>
                                                                          <div class="qty-box">
                                                                  ...
                                                                  <div class="flex-grow-1">
                                                                      <div class="common-space user-id w-100">
                                                                          <div class="common-space w-100"> <a
                                                                                  class="f-w-500 f-12"
                                                                                  href="{{ route('admin.chat_private') }}">Robert
                                                                                  D. Hambly</a></div>
                                                                      </div>
                                                              ...
                                                              <div
                                                                  ...
                                                                  <div class="flex-grow-1">
                                                                      <div class="common-space user-id w-100">
                                                                          <div class="common-space w-100"> <a
                                                                                  class="f-w-500 f-12"
                                                                                  href="{{ route('admin.chat_private') }}">Courtney
                                                                                  C. Strang</a></div>
                                                                      </div>
                                                              ...
                                                              <div
                                                                  ...
                                                                  <div class="flex-grow-1">
                                                                      <div class="common-space user-id w-100">
                                                                          <div class="common-space w-100"> <a
                                                                                  class="f-w-500 f-12"
                                                                                  href="{{ route('admin.chat_private') }}">Raye
                                                                                  T. Sipes</a></div>
                                                                      </div>
                                                                      <div><span class="f-w-500 f-light f-12">Hello
                                                              ...
                                                              <div
                                                                  ...
                                                                  <div class="flex-grow-1">
                                                                      <div class="common-space user-id w-100">
                                                                          <div class="common-space w-100"> <a
                                                                                  class="f-w-500 f-12"
                                                                                  href="{{ route('admin.chat_private') }}">Henry
                                                                                  S. Miller</a></div>
                                                                      </div>
                                                      ...
                                                      <ul>
                                                          <li class="pr-0 pl-0 pb-3">
                                                              <div class="media"><img
                                                                  ...
                                                                  <div class="media-body"><a class="f-light f-w-500"
                                                                          href="{{ route('admin.product') }}">Furniture
                                                                          Chair for Home</a>
                                                                      <div class="qty-box">
                                                                          <div class="input-group"> <span
                                                                                  class="input-group-prepend">
                                                          ...
                                                          <li class="pr-0 pl-0 pb-3 pt-3">
                                                              <div class="media"><img
                                                                      ...
                                                                      alt="">
                                                                  <div class="media-body"><a class="f-light f-w-500"
                                                                          href="{{ route('admin.product') }}">Men Cotton
                                                          ...
                                                          <li class="mb-3 total"><a href="{{ route('admin.checkout') }}">
                                                                  <h6 class="mb-0">
                      ...
                      <li class="profile-nav onhover-dropdown">
                          <div class="media profile-media"><img class="b-r-10"
                                  src="{{ asset('assets/images/dashboard/Oregano-Logo_English_page-0001.jpg') }}" alt="">
                          ...
                          <ul class="profile-dropdown onhover-show-div">
                              <li><a href="{{ route('admin.default_dashboard') }}"><i data-feather="user"></i><span>My Profile</span></a>
                              </li>
                              <!-- <li><a href="{{ route('admin.letter_box') }}"><i data-feather="mail"></i><span>Inbox</span></a></li> -->
