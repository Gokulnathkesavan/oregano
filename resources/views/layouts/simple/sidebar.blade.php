    ...
    <a href="{{ route('admin.default_dashboard') }}" class="text-logo">
        <span class="logo-initials">DD</span>
        <span class="logo-text">ividesk</span>
    </a>
...
<div class="logo-icon-wrapper">
    <a href="{{ route('admin.default_dashboard') }}" class="text-logo-icon">
        <span class="logo-initials">DD</span>
    </a>
</div>

<style>
.text-logo, .text-logo-icon {
    display: flex;
    align-items: center;
...
.text-logo:hover .logo-initials, .text-logo-icon:hover .logo-initials {
    transform: translateY(-3px);
}

.text-logo:hover .logo-initials::after, .text-logo-icon:hover .logo-initials::after {
    bottom: -8px;
    height: 7px;
...
.text-logo:hover .logo-text {
    color: #feca57; /* bright hover accent */
}
</style>
                    ...
                    <ul class="sidebar-links" id="simple-bar">
                        ...
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"> </i><a class="sidebar-link sidebar-title"
                            ...
                            <ul class="sidebar-submenu">
                                <li><a href="{{ route('admin.default_dashboard') }}">Analytics</a></li>
                        ...
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title"
                                ...
                                </svg><span class="">Master</span></a>
                            <ul class="sidebar-submenu">
                                <li><a href="{{ route('admin.outlets.index') }}">Outlet</a></li>
                                <li><a href="{{ route('admin.entries.index') }}">Entry</a></li>
                            </ul>
                        </li>
                        <!-- <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title"
                                href="javascript:void(0)">
